...
def handle_login():
    ...
    if (result['success']==True ):
     ...
     encrypted_tgt=result["encrypted_tgt"]
     ...
     response=request_tgs(encrypted_tgt,service_id,encrypted_authticator)
     ...
     if response["success"]==True :
        ...
        result3=request_ressource_service(response["encrypted_service_ticket"],encrypted_authticator)
